...
file_path = \
    r'D:\Lisa\data\Andrea\AAV2\Andrea_AAV2KCl9.6mM_analysis.h5'
...
ax = sns.heatmap(heatmap, vmin=0, vmax=500, cmap='PuBuGn')
...
plt.savefig('Andrea_AAV2KCl9.6mM_heatmap.png')
plt.show()